...
from bookshop.factories import BookFactory, CategoryFactory,UserFactory,OrderFactory,OrderItemFactory
...
def test_create_book_admin():
    ...
    api_client = APIClient()
    category = CategoryFactory()
    data = {'title': 'Book', 'price': '50.00', 'stock': 2,'author': 'test','category': [category.id]}
