...
from menu_fucntions import add_new_order, add_product_to_order, change_price, change_quantity, exit_shop, show_order, show_products
...
menu = {
    ...
    5: ("Show order", show_order),
    6: ("Add new order",add_new_order),
    0: ("Exit",exit_shop)
}