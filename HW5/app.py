...
crypto_db = {
    ...
    "ETH": {
        "name": "Ethereum",
        "price": 3500,
        "desc": "Король смарт-контрактов и децентрализованных приложений.",
    },
    "SOL": {
        "name": "Solana",
        "price": 140,
        "desc": "Сверхбыстрый блокчейн для масштабируемых приложений.",
    },
    "BNB": {
        "name": "Binance Coin",
        "price": 600,
        "desc": "Токен крупнейшей криптобиржи Binance.",
    },
    "TON": {
        "name": "Toncoin",
        "price": 7.5,
        "desc": "Криптовалюта, интегрированная в экосистему Telegram.",
    },
    "DOGE": {
        "name": "Dogecoin",
        "price": 0.15,
        "desc": "Любимая мем-монета Илона Маска.",
    },
    "ADA": {
        "name": "Cardano",
        "price": 0.45,
        "desc": "Блокчейн, построенный на научных исследованиях.",
    },
    "DOT": {
        "name": "Polkadot",
        "price": 7.2,
        "desc": "Протокол для объединения разных блокчейнов.",
    },
}
...
def exchanger():
    ...
    return render_template(
        "exchanger.html", result=result, currency=currency, coins=crypto_db
    )
